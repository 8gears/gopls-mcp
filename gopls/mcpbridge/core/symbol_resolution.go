...
// symbolLocation returns the protocol.Location of the given symbol within the file uri.
// Adapted from gopls/internal/mcp/symbol_references.go
...
//   - For length 3 paths, the symbol is a field or method on an imported object.
//
// Adapted from gopls/internal/mcp/symbol_references.go
